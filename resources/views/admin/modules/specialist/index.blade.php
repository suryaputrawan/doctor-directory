    ...
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-header flex flex-align-center">
                <h6 class="card-title flex-full-width mb-0">Specialist List</h6>
                        ...
                        <div class="col-sm-12">
                            <div class="mb-3">
                                ...
                                <input name="name" id="name" type="text" class="form-control"
                                    placeholder="Example: Dental" value="{{ old('name') }}">
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        let dataTable = $("#datatable").DataTable({
            ...tableOptions,
            ajax: "{{ route('admin.specialists.index') }}?type=datatable",
            processing: true,
            serverSide : true,
            scrollX: true,
            responsive: false,
        ...
        // form environtment
        let ajaxUrl = "{{ route('admin.specialists.store') }}";
        let ajaxType = "POST";
        ...
        $("#btn-add").click(function() {
            ajaxUrl = "{{ route('admin.specialists.store') }}";
            ajaxType = "POST";
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.status == 404) {
                        ...
                        ajaxUrl = "{{ route('admin.specialists.index') }}/"+response.data.id;
                        ajaxType = "PUT";
