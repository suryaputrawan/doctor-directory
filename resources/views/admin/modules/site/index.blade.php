    ...
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-header flex flex-align-center">
                <h6 class="card-title flex-full-width mb-0">Site List</h6>
                        ...
                        <div class="col-sm-12">
                            <div class="mb-3">
                                ...
                                <input name="name" id="name" type="text" class="form-control"
                                    placeholder="Insert sites here.." value="{{ old('name') }}">
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        let dataTable = $("#datatable").DataTable({
            ...tableOptions,
            ajax: "{{ route('admin.sites.index') }}?type=datatable",
            processing: true,
            serverSide : true,
            scrollX: true,
            responsive: false,
        ...
        // form environtment
        let ajaxUrl = "{{ route('admin.sites.store') }}";
        let ajaxType = "POST";
        ...
        $("#btn-add").click(function() {
            ajaxUrl = "{{ route('admin.sites.store') }}";
            ajaxType = "POST";
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.status == 404) {
                        ...
                        ajaxUrl = "{{ route('admin.sites.index') }}/"+response.data.id;
                        ajaxType = "PUT";
