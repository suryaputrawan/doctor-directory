    ...
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-header flex flex-align-center">
                <h6 class="card-title flex-full-width mb-0">Sub Specialist List</h6>
            ...
            <div id="item-layout" class="card-body" style="display: none">
                <form id="item-form">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="mb-3">
                                <label class="form-label">Sub Specialist Name <span class="text-danger">*</span></label>
                                <input name="name" id="name" type="text" class="form-control"
                                    placeholder="Insert sub specialist name.." value="{{ old('name') }}">
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        let dataTable = $("#datatable").DataTable({
            ...tableOptions,
            ajax: "{{ route('admin.sub-specialists.index') }}?type=datatable",
            processing: true,
            serverSide : true,
            scrollX: true,
            responsive: false,
        ...
        // form environtment
        let ajaxUrl = "{{ route('admin.sub-specialists.store') }}";
        let ajaxType = "POST";
        ...
        $("#btn-add").click(function() {
            ajaxUrl = "{{ route('admin.sub-specialists.store') }}";
            ajaxType = "POST";
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.status == 404) {
                        ...
                        ajaxUrl = "{{ route('admin.sub-specialists.index') }}/"+response.data.id;
                        ajaxType = "PUT";
