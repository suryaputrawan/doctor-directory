    ...
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-header flex flex-align-center">
                <h6 class="card-title flex-full-width mb-0">Doctor List</h6>
                <a href="{{ route('admin.doctors.create') }}" type="button" class="btn btn-sm btn-primary btn-icon-text">
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        let dataTable = $("#datatable").DataTable({
            ...tableOptions,
            ajax: "{{ route('admin.doctors.index') }}?type=datatable",
            processing: true,
            serverSide : true,
            scrollX: true,
            responsive: false,
            columns: [
                ...
                { data: "specialist", name: "specialist", orderable: true  },
                { data: "sub_specialist", name: "sub_specialist", orderable: true  },
                { data: "site", name: "site", orderable: true  },
